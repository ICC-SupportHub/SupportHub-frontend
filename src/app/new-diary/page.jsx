...
export default function NewDiary() {
  ...
  const handleSaveDiary = async () => {
    ...
    if (!diaryEntry.trim()) {
      setAiFeedback("오늘 있었던 이야기를 조금이라도 적어주세요. 아무것이나 괜찮아요! ✍️")
      return
    }
  ...
  // 감정 이모티콘과 색상
  const emotions = [
    { name: "happy", emoji: "😊", label: "행복함", color: "bg-gradient-to-br from-amber-300 to-amber-400" },
    { name: "joy", emoji: "😆", label: "즐거움", color: "bg-gradient-to-br from-pink-300 to-pink-400" },
    { name: "depressed", emoji: "😔", label: "우울함", color: "bg-gradient-to-br from-blue-400 to-blue-500" },
    { name: "frustrated", emoji: "😤", label: "답답함", color: "bg-gradient-to-br from-orange-300 to-orange-400" },
    { name: "tired", emoji: "😴", label: "피곤함", color: "bg-gradient-to-br from-purple-300 to-purple-400" },
    { name: "angry", emoji: "😠", label: "화남", color: "bg-gradient-to-br from-red-400 to-red-500" },
    { name: "irritated", emoji: "😒", label: "짜증남", color: "bg-gradient-to-br from-red-300 to-red-400" },
  ]
  ...
  const emotionColors = {
    ...
    depressed: "bg-gradient-to-br from-blue-400 to-blue-500 text-white",
    frustrated: "bg-gradient-to-br from-orange-300 to-orange-400 text-black",
    tired: "bg-gradient-to-br from-purple-300 to-purple-400 text-white",
    angry: "bg-gradient-to-br from-red-400 to-red-500 text-white",
    irritated: "bg-gradient-to-br from-red-300 to-red-400 text-white",
  }
    ...
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="border-b bg-white dark:bg-gray-800 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white">새 일기 작성하기</h1>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-2xl mx-auto space-y-6">
          {/* Date Selection */}
          <div>
            <Label className="text-base mb-3 block">언제의 이야기인가요?</Label>
            <input
              type="date"
              ...
              className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent w-48"
            />
          </div>

          {/* Weather Selection */}
          <div>
            <Label className="text-base mb-3 block">오늘 날씨는 어땠나요?</Label>
               ...
               {weathers.map((weather) => (
                 <Button
                   ...
                   className={`flex flex-col items-center justify-center p-3 h-auto w-20 text-lg transition-all duration-300 ease-in-out rounded-xl ${
          ...
          {/* Emotion Selection */}
          <div>
            <Label className="text-base mb-3 block">오늘은 어떤 하루였나요?</Label>
                         <div className="flex gap-3 flex-wrap">
          ...
          {/* Diary Entry */}
          <div>
            <Label className="text-base mb-3 block">오늘 있었던 이야기를 들려주세요</Label>
                         <Textarea
          ...
          {/* Image Upload */}
          <div>
            <Label className="text-base mb-3 block">특별한 순간을 담은 사진이 있나요? (선택)</Label>
          ...
          {/* AI Feedback */}
          {aiFeedback && (
            <div className="p-4 rounded-lg bg-purple-50 border border-purple-200 text-purple-800">
